...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='F:/weights/yolov9-c.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/football-players-detection/data.yaml', help='dataset.yaml path')
